...
// Meridian Coffee menü ve işletme verilerini SQLite (database/menu.db) veritabanına aktarır.
  ...
  return new Promise((resolve, reject) => {
    db.serialize(() => {
      ...
      const settingsToInsert = [
        { key: 'company_name', value: meridianData.info.name },
        { key: 'restaurant_name', value: meridianData.info.name },
        { key: 'admin_brand_text', value: meridianData.info.name },
        { key: 'phone', value: meridianData.info.phone },
        { key: 'address', value: meridianData.info.address },
        { key: 'plus_code', value: meridianData.info.plus_code },
        { key: 'rating', value: String(meridianData.info.rating) },
        { key: 'reviews_count', value: String(meridianData.info.reviews_count) },
        { key: 'price_range', value: meridianData.info.price_range },
        { key: 'restaurant_description', value: `${meridianData.info.address} | Tel: ${meridianData.info.phone}` },
...
seedDatabase().then(() => {
  console.log('✅ Meridian Coffee verileri SQLite (database/menu.db) veritabanına başarıyla aktarıldı!');
  db.close();
}).catch((err) => {
